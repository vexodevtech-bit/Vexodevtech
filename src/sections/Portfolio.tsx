...
import { ExternalLink, Github, X, PlayCircle, Layers, Monitor, Car, Cpu, Code2, Bot, Layout, Palette, Package } from 'lucide-react';
                ...
                <div className="w-full lg:w-[450px] p-10 md:p-14 overflow-y-auto bg-brand-dark/50 backdrop-blur-md">
                  ...
                  <div className="flex flex-col gap-4">
                    <a
                      ...
                      className="w-full py-6 rounded-2xl bg-brand-blue text-brand-dark font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:shadow-[0_0_30px_rgba(0,243,255,0.4)] transition-all active:scale-[0.98]"
                    >
                      Initialize Module <ExternalLink size={20} />
                    </a>
                    <a
                      href={selectedProject.githubUrl}
                      className="w-full py-6 rounded-2xl bg-white/5 border border-white/10 text-white font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-white/10 transition-all active:scale-[0.98]"
                    >
